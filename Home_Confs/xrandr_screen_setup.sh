...
xrandr --output DisplayPort-3 --mode 3440x1440 --rate 100.00 --primary --pos 0x0 --rotate normal --output HDMI-A-1 --mode 1920x1080 --rate 120.00 --pos 750x-1425 --rotate normal
